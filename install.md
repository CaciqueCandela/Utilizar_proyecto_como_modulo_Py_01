# Final Project 01 guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `final_project_01/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `final_project_01` folder and use the modules inside your notebooks :
...
```python
from final_project_01.utils.paths import data_dir
data_dir()
```
